...
export const goldBar: React.CSSProperties = {
...
export const detailsCard: React.CSSProperties = {
  backgroundColor: "#F9F7F4",
  padding: "24px 28px",
  border: "1px solid #E5E5E5",
};
...
export const workshopTitle: React.CSSProperties = {
  color: "#2B2B2B",
  fontSize: "18px",
  fontWeight: "700",
  margin: "0 0 16px",
...
export const thinDivider: React.CSSProperties = {
  borderColor: "#E5E5E5",
  margin: "0 0 14px",
};
...
export const summaryLeft: React.CSSProperties = {
  color: "#8C8C8C",
  fontSize: "13px",
  margin: 0,
};

export const summaryTotal: React.CSSProperties = {
  color: "#2B2B2B",
  fontSize: "22px",
  fontWeight: "700",
  margin: 0,
...
export const receiptLink: React.CSSProperties = {
  color: "#C9A84C",
  fontSize: "12px",
  display: "block",
  marginTop: "12px",
...
export const footerCopy: React.CSSProperties = {
  color: "#C5C5C5",
  fontSize: "11px",
