    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
          {GALLERY_SECTION_DATA.map((e) => (
            <div key={e.title} className="gs-card">
              <Link
                href={`/events/${e.slug}`}
                className="group block bg-white border border-light-gray overflow-hidden transition-transform duration-300 ease-in-out hover:-translate-y-1 hover:shadow-[0_20px_48px_rgba(0,0,0,0.1)] h-full"
              >
                ...
                <div className="p-7 pb-8">
                  ...
                  <span className="flex items-center gap-2 font-extrabold text-[13px] text-charcoal hover:text-gold transition-colors">
